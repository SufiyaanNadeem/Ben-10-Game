...
class Font:
    ...
    Default = pygame.font.SysFont("Exo-Medium", 30)
    Small = pygame.font.SysFont("Exo-Bold", 15)
    Medium = pygame.font.SysFont("Exo-Bold", 40)
    Large = pygame.font.SysFont("Exo-Bold", 60)
    Scanner = pygame.font.SysFont("Exo-Bold", 30)
