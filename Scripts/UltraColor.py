...
All this class does is make importing colours more convinient for me. This way I don't have to right rgb values whenever I just want a simple colour to be blitted.
"""
